...
\hypersetup{
  pdftitle={A template for an NDA report},
  pdfauthor={NDA},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{A template for an NDA report}
\author{NDA}
\date{31/07/2023}
...
\chapter*{subtítulo!}\label{subtuxedtulo}}
\addcontentsline{toc}{chapter}{subtítulo!}

\markboth{subtítulo!}{subtítulo!}

br()

\begin{figure}[H]

{\centering \includegraphics{./images/ine_logo_principal_cores_863x315.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{a very long line of R code that wraps }\ControlFlowTok{in}\NormalTok{ html, epub and PDF}\SpecialCharTok{!}\NormalTok{ In a pdf especially this is needed}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{a very long line of R code that wraps in html, epub and PDF! In a pdf especially this is needed}
...
{\centering \includegraphics[width=3.4in,height=\textheight]{./images/gosling.jpg}
...
{\centering \includegraphics{./images/ine_logo_secundario_cores_491x57.png}
