...
\hypersetup{
  pdftitle={A template for generating a valid EPUB, a KDP-ready PDF and a website for your book},
  pdfauthor={Bruno Rodrigues},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{A template for generating a valid EPUB, a KDP-ready PDF and a
